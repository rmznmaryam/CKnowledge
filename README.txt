README
Summary:
this code produces different outputs based on the user's input. 
If the user did not input anything, the code assume they want to see 3 disks 
moving from tower 1 to tower 2. If the user only inputs one number, that number 
is the number of disks to be moved from tower 1 to 2.
